...
public class HeartBeatReceiverHandler implements Runnable {

    private Socket toClient;
    private HashMap<ServerInfo, Date> serverStatus;
    private int localPort;

    public HeartBeatReceiverHandler(Socket toClient, HashMap<ServerInfo, Date> serverStatus, int localPort) {
