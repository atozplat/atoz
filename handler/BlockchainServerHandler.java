...
public class BlockchainServerHandler implements Runnable {
    ...
    public BlockchainServerHandler(Socket clientSocket, Blockchain blockchain, HashMap<ServerInfo, Date> serverStatus, int localPort) {
